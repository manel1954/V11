...
sed -i "10c Name[es_ES]=Desactivate Dvswitch" $usuario/Desktop/Activar_dvswitch.desktop
...
sed -i "10c Name[es_ES]=Desactivar Dvswitch" $usuario/Desktop/Activar_dvswitch.desktop
fi
